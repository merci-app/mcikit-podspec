#
#  Be sure to run `pod spec lint MarketPlaceKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
    ...
    spec.source       = { :git => 'https://github.com/merci-app/mcikit-podspec.git', :tag => '2.2.2-dev.01' }
